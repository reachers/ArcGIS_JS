...
function(declare, lang, array, html, topic, aspect, query, nld, nlm, on, require,
  ...
  var clazz = declare([BaseWidget], {
    ...
    createPopupLinkNode: function(){
      ...
      this.popupSigninNode = this.createLinkNode(node, {label: 'SignIn', url: '#'}, true);
      this.popupUserNameNode = this.createLinkNode(node, {label: '', url: '#'}, true);
      this.popupSignoutNode = this.createLinkNode(node, {label: 'SignOut', url: '#'}, true);
      ...
      //empty
      this.createLinkNode(node, {label: '', url: '#'}, false);
      return node;
    },
